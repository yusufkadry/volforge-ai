...
export async function critic(candidate: Candidate): Promise<CriticVerdict> {
  ...
  const prompt = [
    ...
    "Approve only if this is a liquid, bounded-risk paper trade whose IV discount is meaningful. Reject ambiguous or weak cases.",
    JSON.stringify({
